...
class IterativeRefinementGenerator(object):
    ...
    def generate(self, model, batch, alphabet=None, 
        ...
        self._encoder_out = utils.recursive_to(encoder_out, "cpu")
        ...
        # initial_output_tokens: fill masked tokens with tokens predicted by encoder.
        #                        fill visible tokens with previous(real) tokens.
        # initial_output_scores: same shape with initial_output_tokens, all zeros
        ...
        for step in range(max_iter):
            ...
            decoder_out = model.forward_decoder(
                ...
                encoder_out=encoder_out,    # use mpnn sequence feature
        ...
        return decoder_out['output_tokens'], decoder_out['output_scores'], decoder_out["logits"]
