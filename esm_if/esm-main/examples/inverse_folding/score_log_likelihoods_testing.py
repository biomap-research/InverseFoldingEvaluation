...
import sys
# from pathlib import Path
# ROOT_PATH = Path('/nfs_beijing/yifan/1114/esm_if/esm-main')
# sys.path.insert(0, ROOT_PATH)
sys.path.append('/nfs_beijing/yifan/1114/esm_if/esm-main/esm/inverse_folding')
import esm
import esm.inverse_folding
from util import score_sequence
